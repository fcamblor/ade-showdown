...
export const LATEST_KNOWN_FEATURES: FeatureSupport[] = [
  ...
  { featureId: 'multiple-model-families', support: 'yes', note: 'Supports OpenAI, Anthropic, Google Gemini, Ollama, LM Studio, llama.cpp, Claude Code, Kimi CLI, Codex, Copilot CLI.', screenshots: [] },
  ...
  { featureId: 'self-hosted', support: 'no', note: 'Proprietary codebase.', screenshots: [] },
