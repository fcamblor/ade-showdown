  ...
  modelIntegrations: [
    {
      ...
      sourceExtract: 'Cursor supports all frontier coding models from OpenAI, Anthropic, Google, and more.',
    },
    {
      vendor: 'OpenAI',
      kind: 'unknown',
    ...
    },
    {
      ...
      kind: 'unknown',
      sourceUrl: 'https://cursor.com/docs/models',
      sourceExtract: "Composer 2.5 is Cursor's own model, trained to be highly capable for agentic coding.",
    },
  ],
  trackingSources: [
    {
