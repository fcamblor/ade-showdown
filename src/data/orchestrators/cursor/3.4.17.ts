...
const data: OrchestratorVersion = {
  ...
  features: [
    ...
    },
    {
      ...
      sourceExtract: 'When you start or move an agent into a worktree from the Agents Window, Cursor creates a separate checkout for that agent. Each task gets its own files, dependencies, and changes while your main checkout stays untouched.',
    },
    {
      ...
      sourceExtract: 'Move an agent session from local to cloud to keep it running while you\'re offline, or so that you can move on to the next task.',
    },
    {
      ...
      sourceExtract: 'Run many agents in parallel across repos and environments: locally, in worktrees, in the cloud, and on remote SSH.',
    },
    {
      ...
      sourceExtract: 'Available models include Claude 4.5/4.6/4.7 (Anthropic), GPT-5 / GPT-5.x (OpenAI), Gemini 2.5 / 3 (Google), Composer 1/2 (Cursor), Grok (xAI), and Kimi K2.5 (Moonshot).',
    },
    {
      ...
      sourceExtract: 'A new PR review experience is now available in Cursor 3. Take PRs from creation to merge all in one place.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'Cursor enables agents to run shell commands directly in your terminal, with safe sandbox execution on macOS, Linux, and Windows.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/pricing',
      sourceExtract: 'Hobby (Free) — No credit card required — Limited Agent requests — Limited Tab completions.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/pricing',
      sourceExtract: 'Enterprise — Custom — Pooled usage, SCIM seat management, granular admin and model controls.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: '/worktree command — creates a separate git worktree so changes happen in isolation.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/docs/configuration/worktrees',
      sourceExtract: 'setup-worktree-unix / setup-worktree-windows / setup-worktree — An array of shell commands executed sequentially in the worktree, or a string filepath to a script file relative to .cursor/worktrees.json.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/changelog/05-07-26',
      sourceExtract: 'A new PR review experience is now available in Cursor 3. Take PRs from creation to merge all in one place. The Reviews tab shows inline review threads and top-level PR comments.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/docs/agent/tools/terminal',
      sourceExtract: 'Agent runs terminal commands in a restricted environment that blocks unauthorized file access and network activity. Commands execute automatically while staying confined to your workspace.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'In Cursor 3\'s Agents Window, there is no way to view the file tree/explorer alongside the agent chat.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'Cursor Commands are reusable AI prompts saved as Markdown files in .cursor/commands/. Type "/" in Cursor\'s chat input to list every command from your project and your global library.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'Project-Level Rules — stored in .cursor/rules, version-controlled and scoped to your codebase. User-Level Rules — Global to your Cursor environment. Team-Level Rules — Team-wide rules managed from the dashboard. Available on Team and Enterprise plans.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'Cursor Web: Start and manage agents from cursor.com/agents on any device. Slack / Linear: Use the @cursor command to kick off an agent. Comment @cursor on a PR or issue to kick off an agent. On iOS, open cursor.com/agents in Safari, tap the share button, then "Add to Home Screen".',
    },
    {
      ...
      sourceExtract: 'You can now see a breakdown of your agent\'s context usage. Use these stats to diagnose context issues and improve your setup across rules, skills, MCPs, and subagents.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/docs/models',
      sourceExtract: 'Reasoning variants available (gpt-5-high, gpt-5.2-high, gpt-5.3-codex-high). Max Mode extends the context window to the maximum a model supports.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'The browser allows agents to control a web browser to test applications, visually edit layouts and styles, audit accessibility, convert designs into code, and more.',
    },
    {
      ...
      sourceExtract: 'Plugins package rules, skills, agents, commands, MCP servers, and hooks into distributable bundles.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://forum.cursor.com/t/allow-external-processes-to-open-an-empty-chat-in-the-agents-window-scoped-to-a-chosen-workspace-parity-with-the-regular-ide/160105',
      sourceExtract: 'Allow external processes to open an empty chat in the Agents window scoped to a chosen workspace (parity with the regular IDE).',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/docs/agent/agents-window',
      sourceExtract: 'Work with agents across all your projects from one place. Run many parallel agents in the cloud (and work with them from your phone, web, Slack, GitHub, and Linear).',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://cursor.com/docs/configuration/worktrees',
      sourceExtract: 'We do not recommend symlinking dependencies into the worktree. This can cause issues in the main worktree.',
    },
  ],
};
