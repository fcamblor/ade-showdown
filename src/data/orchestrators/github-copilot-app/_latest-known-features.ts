...
export const LATEST_KNOWN_FEATURES: FeatureSupport[] = [
  ...
  { featureId: 'local-execution', support: 'yes', note: 'Available in technical preview on Windows, macOS, and Linux.', screenshots: [] },
  { featureId: 'multiple-model-families', support: 'no', note: 'Uses GitHub Copilot agent exclusively.', screenshots: [] },
  ...
  { featureId: 'self-hosted', support: 'no', note: 'Proprietary app for paid Copilot subscribers.', screenshots: [] },
  ...
  { featureId: 'pr-status-sync', support: 'yes', note: 'Agent Merge addresses review comments.', screenshots: [] },
  ...
  { featureId: 'llm-assisted-merge-rebase', support: 'yes', note: 'Agent Merge addresses review comments, fixes failing checks, and merges.', screenshots: [] },
