...
const data: OrchestratorVersion = {
  ...
  features: [
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://vibekanban.com/docs/workspaces/interface',
      sourceExtract: 'Toggle Preview — show or hide the preview panel. Toggle Dev Server — start or stop the development server.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://vibekanban.com/docs/workspaces/sessions',
      sourceExtract: "New sessions don't inherit conversation history. The new agent won't know what happened in previous sessions unless you explain it again or it reads the file changes.",
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'Settings — configuration that applies to all projects. Members can edit project settings independent of organization-wide controls.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://vibekanban.com/docs/workspaces/interface',
      sourceExtract: 'PR Status — badge showing linked pull request status. Archive — move completed workspaces out of the main list.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'Controls how much computational effort the model spends "thinking" before responding. Higher reasoning produces more thorough analysis but takes longer and uses more tokens.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://vibekanban.com/docs/supported-coding-agents',
      sourceExtract: 'Vibe Kanban integrates with a variety of coding agents […]. Each agent requires installation and authentication before use.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://vibekanban.com/docs/workspaces/interface',
      sourceExtract: 'Preview View: built-in browser for testing your application. Dev server tabs: multiple dev servers supported. Device modes: desktop, mobile, custom viewport. Process logs: view dev server output.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://vibekanban.com/docs/workspaces/interface',
      sourceExtract: 'The sidebar can toggle between flat list and accordion layouts that group workspaces by status (Needs Attention, Idle, and Running).',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://vibekanban.com/docs/workspaces/creating-workspaces',
      sourceExtract: 'Git worktree creation failed (usually due to uncommitted changes in the original repo). Commit or stash any uncommitted changes in your original repository.',
    },
    {
